...
vcom -93 -work cyclone {d:/quartus/quartus/eda/sim_lib/cyclone_atoms.vhd}
vcom -93 -work cyclone {d:/quartus/quartus/eda/sim_lib/cyclone_components.vhd}
...
vcom -93 -work work {E:/class/FPGACLASS/free/game_lx_ram.vhd}

vcom -93 -work work {E:/class/FPGACLASS/free/tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclone -L rtl_work -L work -voptargs="+acc"  tb
